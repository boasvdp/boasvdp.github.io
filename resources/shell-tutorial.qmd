...
Download the zip file with the exercises from the link in the right sidebar. Either download by left-clicking and save this in your home directory, or use this command:

```
wget <LINK TO BE INSERTED>
