...
\begin{Shaded}
\begin{Highlighting}[]
\BuiltInTok{echo} \StringTok{"hello world"} \hspace*{\fill}\NormalTok{\circled{1}}
\end{Highlighting}
\end{Shaded}
...
\subsection{Navigating}\label{navigating}

\subsection{Viewing files}\label{viewing-files}

\subsection{Changing files}\label{changing-files}
